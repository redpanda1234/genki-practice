    ...
    templates=[
        {
            ...
            "afmt": '<span style="font-family: irohamaru mikami; font-size: 50px;">{{furigana:Reading}}</span>\n\n<hr id=answer>\n\n<div class=left><span style="font-family: irohamaru mikami; font-size: 30px;"><b>Meaning</b>: {{furigana:Meaning}}</span></div>\n\n<hr id=answer>\n\n<div class=left><span style="font-family: irohamaru mikami; font-size: 30px;"><b>Notes:</b> {{furigana:Notes}}</span></div>\n\n<hr>\n\n<div class=left><span style="font-family: irohamaru mikami; font-size: 30px;"><b>Pitch Accent Readings:</b></div>\n<div><span style="font-family: irohamaru mikami; font-size: 30px;"> {{text:Pitch Accent}}</span></div>',
        },
    ],
